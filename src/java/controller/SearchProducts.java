...
public class SearchProducts extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (requestJsonObject.has("condition_name")) {
            ...
            //condition selected
            String condition = requestJsonObject.get("condition_name").getAsString();
        ...
        if (requestJsonObject.has("color_name")) {
            //color selected
            String color = requestJsonObject.get("color_name").getAsString();
        ...
        if (requestJsonObject.has("storage_value")) {
            //color selected
            String storage = requestJsonObject.get("storage_value").getAsString();
